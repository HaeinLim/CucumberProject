...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/my/likeyPost.css">
</head>
<body>
...
<div class="wrapper">
	<div class="col-7">
		<table class="table table-light table-hover">
			...
			<c:forEach var="i" items="${parray}">
				<tr class="pp">
					...
					<td align="center">
						<span class="badge bg-secondary">${i.postState}</span>
		      			${i.postTitle }
		      		</td>
		...
		<c:if test="${empty parray}"><br><div class="no">좋아요 한 게시물이 없습니다</div></c:if>
	</div>
</div>
